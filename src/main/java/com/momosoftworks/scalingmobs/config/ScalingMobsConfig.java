...
public class ScalingMobsConfig
{
    ...
    private static final ForgeConfigSpec.DoubleValue rinkoRatio;
    ...
    static
    {
        ...
        mobsStopBurningDay = BUILDER
                .comment("After this Player Day, all hostile mobs will be immune to burning in daylight")
        ...
        mobHealthRate = BUILDER
                .comment("The decimal amount that hostile mobs' health increase per Player Day")
        ...
        mobDamageRate = BUILDER
                .comment("The decimal amount that hostile mobs' damage increase per Player Day")
        ...
        mobSpeedRate = BUILDER
                .comment("The decimal amount that hostile mobs' speed increase per Player Day")
        ...
        mobPiercingRate = BUILDER
                .comment("The decimal amount of increase to mobs' damage that ignores armor per Player Day")
        ...
        mobDropsRate = BUILDER
                .comment("The decimal amount of increase to mobs' drops per Player Day")
    ...
    public double getRinkoRatio()
    {
        return rinkoRatio.get();
    }
